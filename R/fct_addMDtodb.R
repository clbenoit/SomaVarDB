        ...
        command = tryCatch(
          ...
          error = function(e){
            ...
            frame <- data.frame("variant_id" = variant,
                                "mdurl" = variant,
                                "isMDetailed" = "Error on MobiDetails",
                                "gene.isTumorSuppressor" = "Error on MobiDetails",
                                "gene.isOncogene" = "Error on MobiDetails",
                                #"gene.canonical" = "Error on MobiDetails",
                                "frequenciesDatabases.dbSNPrsid" = "Error on MobiDetails",
                                "frequenciesDatabases.gnomADv3" = "Error on MobiDetails",
                                "missensePredictions.siftPred"  = "Error on MobiDetails",
                                "missensePredictions.siftScore" = "Error on MobiDetails",
                                "missensePredictions.polyphen2HdivPred" = "Error on MobiDetails",
                                "missensePredictions.polyphen2HdivScore" = "Error on MobiDetails",
                                "missensePredictions.polyphen2HvarPred" = "Error on MobiDetails",
                                "missensePredictions.polyphen2HvarScore" = "Error on MobiDetails",
                                "frequenciesDatabases.clinvarClinsig" = "Error on MobiDetails",
                                "frequenciesDatabases.clinvarClinsigConf" = "Error on MobiDetails")                             
            rownames(frame) <- variant
            return(frame)
      }),
